...
for i_episode in range(N_EPISODES):
    ...
    for t in range(EPISODE_LENGTH):
        ...
        q_table[state + (action,)] =  q_table[state + (action,)] + lr * (reward + gamma * q_next_max - q_table[state + (action,)])    # update current state-action pair table value by q-learning update equation
